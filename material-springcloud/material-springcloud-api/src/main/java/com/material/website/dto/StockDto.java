...
public class StockDto {
	...
	public String getFormatSingleMoney() {
		return formatSingleMoney;
	}

	public void setFormatSingleMoney(String formatSingleMoney) {
		this.formatSingleMoney = formatSingleMoney;
	}
